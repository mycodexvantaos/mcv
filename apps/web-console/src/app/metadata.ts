...
import { buildCanonicalUrl, getCanonicalUrl, resolveEnvironment } from "@mycodexvantaos/core/config/domains";
...
export function generateOrganizationStructuredData(): Record<string, unknown> {
  ...
  return {
    ...
    sameAs: [
      "https://github.com/mycodexvantaos",
      "https://twitter.com/mycodexvantaos",
    ],
    contactPoint: {
      "@type": "ContactPoint",
...
export function getRootMetadata() {
  ...
  return {
    ...
    keywords: ["AI infrastructure", "agent runtime", "governance", "contract-first", "self-hostable"],
