...
def fix_monitoring_tests():
    ...
    test_file = Path(
        "/workspace/mycodexvantaos/packages/monitoring/__tests__/monitoring.test.ts"
    )
...
def fix_service_discovery_test():
    ...
    test_file = Path(
        "/workspace/mycodexvantaos/packages/service-discovery/__tests__/service-discovery.test.ts"
    )
