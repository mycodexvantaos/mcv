...
This document defines the unified architectural standards and operational guidelines for the **MyCodexVantaOS** Monorepo, incorporating the **AI Context Governance and Navigation Specification** and the **Memory-Driven Persistence Protocol**.
...
### 4. Repository Navigation & Directory Layers (C.2)
