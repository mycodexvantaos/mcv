    ...
    activityFeed: [
      {
        ...
        action: 'DEPLOY',
        resource: 'mycodexvantaos-ai-agent:v1.2.0',
        result: 'success',
        ts: now,
      },
      {
        ...
        actor: 'system',
        action: 'DRIFT_DETECT',
        resource: 'mycodexvantaos-core-gateway',
        result: 'no-drift',
        ts: now,
      },
      {
      ...
      },
      {
        ...
        actor: 'system',
        action: 'SBOM_UPLOAD',
        resource: 'mycodexvantaos-ai-llm:v0.9.1',
        result: 'success',
        ts: now,
      },
      {
        ...
        actor: 'admin@mycodexvantaos.dev',
        action: 'POLICY_CHECK',
        resource: 'opa-admission-control',
        result: 'pass',
        ts: now,
      },
    ],
      ...
      items: [
        {
          id: 'alert-001',
          severity: 'warning',
          message: 'connector-mongodb response time > 300ms',
          ts: now,
        },
        {
          id: 'alert-002',
          severity: 'info',
          message: 'SBOM attestation completed for ai-llm:v0.9.1',
          ts: now,
        },
        {
          id: 'alert-003',
          severity: 'info',
          message: 'Deployment freeze gate active: 2026-05-05 UTC+8',
          ts: now,
        },
        {
          id: 'alert-004',
          severity: 'info',
          message: 'Naming validation passed: 0 violations',
          ts: now,
        },
      ],
    },
