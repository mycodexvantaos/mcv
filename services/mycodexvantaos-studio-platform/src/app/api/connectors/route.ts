...
const CONNECTORS = [
  ...
  },
  {
    ...
    latencyMs: 8,
    version: '1.0.0',
    endpoint: 'postgresql://localhost:5432/mycodexvantaos',
    authType: 'password',
    createdAt: '2026-01-01T00:00:00Z',
  },
  {
  ...
  },
  {
    ...
    latencyMs: 320,
    version: '1.0.0',
    endpoint: 'mongodb://localhost:27017/mycodexvantaos',
    authType: 'password',
    createdAt: '2026-01-01T00:00:00Z',
  },
  {
  ...
  },
  {
    ...
    latencyMs: 12,
    version: '1.0.0',
    endpoint: 'https://auth.mycodexvantaos.dev',
    authType: 'oidc',
    createdAt: '2026-01-01T00:00:00Z',
  },
];
...
export async function POST(req: NextRequest) {
  ...
  if (!name || !type || !endpoint) {
    return NextResponse.json(
      { success: false, error: 'name, type, and endpoint are required' },
      { status: 400 }
    );
  }
...
export async function PUT(req: NextRequest) {
  ...
  if (!connector) {
    return NextResponse.json(
      { success: false, error: `Connector '${id}' not found` },
      { status: 404 }
    );
  }
  ...
  return NextResponse.json({
    success: true,
    data: { ...connector, ...updates, updatedAt: new Date().toISOString() },
  });
}
