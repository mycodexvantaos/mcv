...
class MetricsPublisher:
    ...
    def publish_to_prometheus(self):
        ...
        prometheus_metrics.append(
            f'mycodexvantaos_execution_total{{id="{self.execution_id}"}} {metrics["total_repositories"]}'
        )
        prometheus_metrics.append(
            f'mycodexvantaos_execution_completed{{id="{self.execution_id}"}} {metrics["completed_repositories"]}'
        )
        prometheus_metrics.append(
            f'mycodexvantaos_execution_failed{{id="{self.execution_id}"}} {metrics["failed_repositories"]}'
        )
