...
export function createChromaVectorProvider(id: string = 'vector-chroma', config?: Partial<ChromaVectorConfig>) {
  ...
  return new ChromaVectorProvider(id, 'ChromaDB Vector Store', { enabled: true, config: config || {} });
}
export async function initializeChromaVectorProvider(id: string = 'vector-chroma', config?: Partial<ChromaVectorConfig>) {
