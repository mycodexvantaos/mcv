...
class RollbackManager:
    ...
    def initiate_rollback(
        self, repository: str, orchestration_id: str, reason: str = ""
    ) -> Dict:
    ...
    def execute_rollback(self, orchestration_id: str, dry_run: bool = False) -> Dict:
...
def main():
    ...
    if args.repository and args.orchestration_id:
        plan = manager.initiate_rollback(
            args.repository, args.orchestration_id, args.reason
        )
