...
class MetricsPublisher:
    ...
    def publish_to_prometheus(self):
        ...
        prometheus_metrics.append(
            f'orchestration_total_repositories{{id="{self.orchestration_id}"}} {metrics["total_repositories"]}'
        )
        prometheus_metrics.append(
            f'orchestration_completed_repositories{{id="{self.orchestration_id}"}} {metrics["completed_repositories"]}'
        )
        prometheus_metrics.append(
            f'orchestration_failed_repositories{{id="{self.orchestration_id}"}} {metrics["failed_repositories"]}'
        )
        prometheus_metrics.append(
            f'orchestration_success_rate{{id="{self.orchestration_id}"}} {metrics["success_rate"]}'
        )
        prometheus_metrics.append(
            f'orchestration_failure_rate{{id="{self.orchestration_id}"}} {metrics["failure_rate"]}'
        )
