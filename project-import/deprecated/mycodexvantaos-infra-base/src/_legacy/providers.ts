/**
 * CodexvantaOS — infra-base Provider Initialization
...
import type { DeployProvider, SecretsProvider } from '@codexvanta/core-kernel';
...
export async function initProviders(): Promise<Providers> {
  ...
  _providers = {
    ...
    secrets: await registry.resolve<SecretsProvider>('secrets'),
  };
