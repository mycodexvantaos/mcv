...
- [ ] Documentation section headings use `## Spec X：Title` or `### Spec X.Y：Title` format (never the section sign prefix)
...
- [ ] Section headings use `## Spec X：Title` or `### Spec X.Y：Title` format (never the section sign prefix)
