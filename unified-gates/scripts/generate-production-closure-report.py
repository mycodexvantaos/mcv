...
def main() -> int:
    ...
    report = {
        "script": "generate-production-closure-report",
    ...
    output_path = output_dir / "generate-production-closure-report-report.json"
    with open(output_path, "w") as f:
        json.dump(report, f, indent=2)

    print(f"generate-production-closure-report: PASSED")
