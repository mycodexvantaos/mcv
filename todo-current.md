...
- [x] Add scripts to root package.json (15 new scripts)
- [x] Add example data files (6 files in examples/)
- [x] Update todo-runtime-activation.md (all 5 loops complete)
...
107 total tests passing (31+9+8+17+23+13 TS + 6 Python)
